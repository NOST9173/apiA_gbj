		...
		<div>
			<table>
				<tr>
					...
					<td >
						<input type="text" name="subject" size="83" maxlength="100" value="<%=bv.getSubject() %>" >
					</td>
				</tr>
				<tr>
					<td style="text-align: center;"></td>
					<td>
						<textarea cols="85" rows="40" name="content"  ><%=bv.getContent() %></textarea>
					</td>
				</tr>
				<tr>
					<td style="text-align: center;"></td>
					<td style="text-align: right;">
						<input type="text" name="writer" size="20" maxlength="50" value="<%=bv.getWriter() %>" >
					</td>
				</tr>
				<tr>
